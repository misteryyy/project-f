 ...
 *
 * @package Boilerplate_View
 */
class Boilerplate_View_Helper_FlashMessenger extends Zend_View_Helper_Abstract
{
    /**
     ...
     */
    public function flashMessenger($key = 'error', $template='<div class="alert alert-%s"><a class="close" data-dismiss="alert">~</a>%s</div>')
    {
